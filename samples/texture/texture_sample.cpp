...
namespace keplar
{
    ...
    void TextureSample::configureVulkan(VulkanContextConfig& /* config */) noexcept
    {
    }
    ...
    bool TextureSample::createCommandBuffers() noexcept
    {
        ...
        {
            VK_LOG_ERROR("TextureSample::createCommandBuffers failed to allocate primary command buffers.");
            return false;
        }
        ...
        {
            VK_LOG_ERROR("TextureSample::createCommandBuffers failed to allocate secondary command buffers.");
            return false;
        }
    ...
    bool TextureSample::recordSceneCommandBuffers() noexcept
    {
        ...
        for (uint32_t i = 0; i < m_maxFramesInFlight; ++i)
        {
            ...
            m_secondaryCommandBuffer[i].draw(6, 1, 0, 0); 
        ...
        VK_LOG_DEBUG("TextureSample::recordSceneCommandBuffers successful");
        return true;
    }

    bool TextureSample::recordFrameCommandBuffer(uint32_t frameIndex, uint32_t imageIndex) noexcept
    {
